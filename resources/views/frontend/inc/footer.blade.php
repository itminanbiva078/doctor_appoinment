        ...
        <div class="footer_row background_blue row">
          <div class="container">
                ...
                <div class="middle_footer">
                    ...
                    <a href="tel:{{ $mobile }}"><i class="fa fa-phone"></i>{{$mobile}}</a>
                        <a href="mailto:{{ $email }}">
                    ...
                    <div class="prod_checbox">
                        <div class="radio-toolbar">
                            ...
                            <?php 
                                 $title = $team["title"];
                            ?>
                            <input onclick="doctorUpdate('<?php echo  $title;?>')" type="radio" id="radio{{$key+1}}">
                                    ...
                                    <span class="step_item_vn">
                                        <span class="row step_item align-items-center">
                                            <span class="step_item_img radius_right">
                                                <img class="lozad is-loaded" src="{!! SM::sm_get_the_src($team["team_image"]) !!}" alt="{{ $team["title"] }}">
                                            </span>
                                            <span class="step_item_desk">
                                                <span class="doctor_name">{{ $team["title"] }}</span>
                                                <span class="doctor_position">{{ $team["designation"] }}</span>
                                            </span>
                                        </span>
                                    </span>
                                </label>
