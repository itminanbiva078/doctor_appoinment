                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">{{ SM::sm_get_count('services') }}</div>
                                            <div class="dashboard-title">Total Services</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ url(config('constant.smAdminSlug') . '/services/')}}">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">{{ SM::sm_get_count('categories')  }}</div>
                                            <div class="dashboard-title">Total Category</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ url(config('constant.smAdminSlug') . '/categories/')}}">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">{{ SM::sm_get_count('contacts')  }}</div>
                                            <div class="dashboard-title">Total Contact</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ url(config('constant.smAdminSlug') . '/contacts/')}}">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge">{{ SM::sm_get_count( 'subscribers')  }}</div>
                                            <div class="dashboard-title">Total Subscriber</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ url(config('constant.smAdminSlug') . '/subscribers/')}}">
                                    <div class="panel-footer">
                                        <span class="pull-left">View Details</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
            ...
            <article class="col-sm-6">
                ...
                <div class="jarviswidget" id="wid-latest_5_contacts-info" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            <table class="table table-striped">
                                @foreach($latest_5_contacts as $contact)
                                    <tr>
                                        <td>
