        ...
        <div>
            ...
            <div class="widget-body padding-10 image-popup-body">
                <div class="form-group">
                    ...
                    <input input_holder="<?php echo e($input_holder); ?>" img_holder="<?php echo e($img_holder); ?>" is_multiple="1"
                    ...
                    <div class="" id="<?php echo e($img_holder); ?>">
                        ...
                        <span class="gl_img">
                             ...
                             <span class="displayNone remove">
                                 <i class="fa fa-times-circle remove_img" data-img="<?php echo e($img_id); ?>" data-input_holder="<?php echo e($input_holder); ?>"></i>
                             </span>
                          </span>
                        <?php
                        }
