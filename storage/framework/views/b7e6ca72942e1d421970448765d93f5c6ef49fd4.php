    ...
    <div class="modal-dialog modal-mizan" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="myModalLabel"><?php echo e(SM::sm_get_site_name()); ?> <?php echo e(__("media.mediaLibrary")); ?></h2>
            </div>
            <div class="modal-body">
                <ul id="sm_media_tab" class="nav nav-tabs bordered">
					...
					?>
                    <li class="active">
                        <a href="#upload_media_tab" data-toggle="tab"><?php echo e(__("media.uploadMediaFiles")); ?></a>
                    </li>
					<?php
					}
					?>
