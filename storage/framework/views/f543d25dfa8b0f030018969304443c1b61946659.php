...
<main>
       <!-- Start Testimonials -->
            ...
            <div class="row recent_testimonials">
                <div class="container">
                    <h4><?php echo e($testimonial_title); ?></h4>
                        ...
                        <div class="recent_testimonials_item row">
                            <div class="recent_testimonials_item_l"> 
                                <div class="recent_testimonials_title row">
                                    <img class="lozad" src="<?php echo SM::sm_get_the_src($value['testimonial_image']); ?>" alt="<?php echo e($value['title']); ?>" />
                                    <div class="recent_testimonials_name"><?php echo e($value['title']); ?></div>
                                </div> 
